 ...
 *
 */
public class ObservableLispInterpreterWithEnvironmentAndLazyEvaluation implements InterpreterModel {
	...
	public ObservableLispInterpreterWithEnvironmentAndLazyEvaluation() {
		scanner = ScannerFactory.newInstance();
		parser = ParserFactory.newInstance();
		listeners = new ArrayList<>();
		rootEnvironment = EnvironmentFactory.newInstance();
	}
